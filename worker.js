var authConfig = {
  siteName: "JRs Cloud",  // Your site name
  root_pass: "",  // Root directory password, takes precedence over .password
  version: "1.0.7",  // Version of the site
  theme: "material",  // Theme: material or classic
...
<head>
  ...
  <!-- Custom App Script -->
  <script src="https://pub-c1de1cb456e74d6bbbee111ba9e6c757.r2.dev/app.js"></script>
</head>
<body class="bg-gray-100 text-gray-800 font-sans">
  ...
  <div class="min-h-screen flex flex-col justify-center items-center">
    <div class="bg-white p-8 rounded-lg shadow-md max-w-lg w-full">
      <h1 class="text-4xl font-bold text-center text-indigo-600 mb-6">${authConfig.siteName}</h1>
      <p class="text-lg text-center text-gray-600 mb-4">Version: <span class="text-indigo-500">${authConfig.version}</span></p>
